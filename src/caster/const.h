...
#define cmd_gameOpt	92
#define res_gameOpt	93
#define cmd_dataOpt	94
#define res_dataOpt	95


// cowcaster identifier - fifth byte is protocol version, update when changed
#define cowcaster_protocol_version 0x06
static const char cowcaster_id[5] = { 'C', 'C', 0xa0, 0xa1, cowcaster_protocol_version };
static const char cowcaster_version_string[] = "150104";
