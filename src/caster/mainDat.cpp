...
//			autoWaitFlg = 1;
		...
		iniReadStringNonUnicode( L"RAN_BATTLE", L"ran_server" , L"\0", ran_server , sizeof(ran_server) - 1 , iniPath);
		...
		//RelayControl
		relayControlFlg = GetPrivateProfileIntW( L"MAIN", L"relayControl", 0, iniPath );
		...
		keybind_strings[KEY_ROUND_COUNT] = L"roundCount";
