...
#include "const.h"
	...
	#include "../guiClass.h"
	#include "../guiIO.h"
	#define cout N_Gui::gout
	#define cin  N_Gui::gin
	
	#define GetKeyState(param) \
			N_Gui::g_gui->GetKeyStateReplace(param)
#endif
...
class mainDatClass{
	...
	gameOptStruct myGameOpt;
	gameOptStruct enGameOpt;
	gameOptStruct dataGameOpt;
	WORD relayControlFlg;
	WORD relaySpectateMode;
	WORD gameOptRecvFlg;
};
