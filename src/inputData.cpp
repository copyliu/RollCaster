...
void inputDataClass::SetTime( BYTE sessionNo, DWORD gameTime ){
	if( !sessionNo ) return;
...
DWORD inputDataClass::GetTime( BYTE sessionNo ){
...
//SetInputData
int inputDataClass::SetInputDataArea( WORD sessionNo, DWORD Time, BYTE* Address, WORD Size ){
...
void inputDataClass::SetInputData( WORD sessionNo, DWORD Time, WORD Side, BYTE Input ){
	if( !sessionNo ) return;
...
void inputDataClass::SetInputDataA( WORD sessionNo, DWORD Time, BYTE Input ){
	if( !sessionNo ) return;
	if( (DWORD)( Time / 2 ) * 2 != Time ) return;
	if( sessionNo == inputDataSub[0].dataInfo.sessionNo ){
...
void inputDataClass::SetInputDataB( WORD sessionNo, DWORD Time, BYTE Input ){
	if( !sessionNo ) return;
	if( (DWORD)( Time / 2 ) * 2 != Time ) return;
	if( sessionNo == inputDataSub[0].dataInfo.sessionNo ){
...
//GetInputData
BYTE* inputDataClass::GetInputDataAddress( WORD sessionNo, DWORD Time, WORD Size ){
	if( !sessionNo ) return 0;
	if( sessionNo == inputDataSub[0].dataInfo.sessionNo ){
...
int inputDataClass::GetInputData( WORD sessionNo, DWORD Time, WORD Side, BYTE* Input){
	if( !sessionNo ) return 1;
...
int inputDataClass::GetInputDataA( WORD sessionNo, DWORD Time, BYTE* Input){
	if( !sessionNo ) return 1;
	if( sessionNo == inputDataSub[0].dataInfo.sessionNo ){
...
int inputDataClass::GetInputDataB( WORD sessionNo, DWORD Time, BYTE* Input){
	if( !sessionNo ) return 1;
	if( sessionNo == inputDataSub[0].dataInfo.sessionNo ){
